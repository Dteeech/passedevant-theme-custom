...
<div class="container mx-auto flex lg:flex-row flex-wrap gap-40 justify-center pb-20">
    <div class="card border-2 border-white p-10">
        <div class="flex items-center space-x-4 justify-between">
            ...
            <div class="background-img_3_blocks">
                <img src="<?php echo get_template_directory_uri() . '/images/logos/logo-seo-light.png'; ?>" alt="Logo"
                    class="inner-logo">
            </div>
        </div>
        <ul class="mt-12">
        ...
        <div class="flex gap-4 mt-8 items-end">
            ...
            <a href=""
                class="flex items-center justify-center w-20 h-20 rounded-full overflow-visible border-white border-4 p-4"><img
                    width="100%" height="auto"
                    src="<?php echo get_template_directory_uri() . '/images/svg/arrow-right-rounded-white.svg' ;?>"
                    alt=""></a>
        </div>
    </div>
    <div class="card border-2 border-white p-10">
        <div class="flex items-center space-x-4 justify-between">
            ...
            <div class="background-img_3_blocks">
                <img src="<?php echo get_template_directory_uri() . '/images/logos/logo-dev-light.png'; ?>" alt="Logo"
                    class="inner-logo">
            </div>
        </div>
        <ul class="mt-12">
    ...
    <div class="card border-2 border-white p-10">
        <div class="flex items-center space-x-4 justify-between">
            ...
            <div class="background-img_3_blocks">
                <img src="<?php echo get_template_directory_uri() . '/images/logos/logo-formation-light.png'; ?>" alt="Logo"
                    class="inner-logo">
            </div>
        </div>
        <ul class="mt-12">
