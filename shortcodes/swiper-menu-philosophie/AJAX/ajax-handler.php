<?php
function get_philosophie_content() {
...
add_action('wp_ajax_get_philosophie_content', 'get_philosophie_content');
add_action('wp_ajax_nopriv_get_philosophie_content', 'get_philosophie_content');
