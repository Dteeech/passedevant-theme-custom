...
?>
    <div class="custom-hero-menu absolute top-20 -right-40 w-1/4 flex flex-col md:flex md:flex-col">
        <div class="link-container seo">
            <a href="/agence-seo" class="link-item lg:text-2xl">Le référencement</a>
        </div>
        <div class="link-container crea-web ms-20">
            <a href="/agence-web" class="link-item lg:text-2xl">La création de site web</a>
        </div>
        <div class="link-container formation ms-36">
            <a href="/404" class="link-item lg:text-2xl">La formation</a>
        </div>
    </div>
    <style>
        .custom-hero-menu {
